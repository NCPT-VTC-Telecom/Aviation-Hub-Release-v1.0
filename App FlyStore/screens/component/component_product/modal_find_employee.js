...
import {fontSizeNormal, typeResponsive} from '../ShortComponent/config';
            ...
            <View
              ...
              <View style={{flexDirection: 'row', marginVertical: 10}}>
                <Text
                  ...
                  {json_language['Chọn nhân viên bán'][language]}
                </Text>
                <TouchableOpacity
              ...
              <View style={[styles.search_container, {padding: 5}]}>
                <AntDesign
                  name="search1"
                  size={23}
...
export default memo(Find_employee);
