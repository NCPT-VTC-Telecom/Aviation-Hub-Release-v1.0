...
import { MaintenanceDeviceService } from "../providers/maintenance_device.service";

export const DevicesProviders = [DeviceService, MaintenanceDeviceService, VerifyLoginMiddleware, LoggerService, DatabaseLogService, ResponseSystemService];
