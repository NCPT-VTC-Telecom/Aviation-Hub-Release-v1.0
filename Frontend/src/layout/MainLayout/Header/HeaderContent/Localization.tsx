...
// assets
import usFlagPng from 'assets/images/icons/png/flag-us.png';
import viFlagPng from 'assets/images/icons/png/flag-vn.png';
...
const Localization = () => {
  ...
  return (
    <Box sx={{ flexShrink: 0, ml: 0.5 }}>
      ...
      >
        {i18n === 'en' ? (
          <img className="!w-[30px]" src={usFlagPng} alt="us flag" />
        ) : (
          <img className="!w-[30px]" src={viFlagPng} alt="vn flag" />
        )}
      </IconButton>
      <Popper
