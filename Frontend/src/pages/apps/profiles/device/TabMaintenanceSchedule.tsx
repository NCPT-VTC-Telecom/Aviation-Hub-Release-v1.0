...
import { DateSelectArg, EventClickArg, EventDropArg, EventSourceInput, LocaleInput } from '@fullcalendar/core';
...
const Calendar = () => {
  ...
  const localeData: LocaleInput = {
    code: intl.locale,
    buttonText: {
      today: intl.formatMessage({ id: 'today' })
    },
    allDayText: intl.formatMessage({ id: 'all-day' })
  };
