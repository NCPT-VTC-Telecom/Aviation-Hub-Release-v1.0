...
const RestrictionUserManagement = () => {
    ...
    <MainCard content={false}>
      <ScrollX>
        <GeneralizedTable
          ...
          data={data}
          handleAdd={handleAdd}
          csvFilename="restriction-user-list.csv"
          addButtonLabel={<FormattedMessage id="add-restriction-user" />}
      ...
      >
        <GenericForm
          title={record ? intl.formatMessage({ id: 'edit-restriction-user' }) : intl.formatMessage({ id: 'add-restriction-user' })}
          isEditMode={!!record}
          onCancel={handleAdd}
      ...
      {recordDelete && (
        <Alert
          alertDelete="alert-delete-restriction-user"
...
export default RestrictionUserManagement;
