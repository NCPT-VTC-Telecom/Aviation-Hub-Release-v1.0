...
function IconRoute({ className, fill }: Props) {
  return (
    <svg
      fill={fill}
      className={className}
    ...
    >
      <g>
        <g>
          <g>
            <path
              d="M120.995,255.996h248.853c54.933,0,99.52-43.093,99.52-96s-44.693-96-99.52-96H127.075
            ...
            />
            <path
              d="M437.368,351.889c-35.307,0-64,28.693-64,64s28.693,64,64,64s64-28.693,64-64S472.782,351.996,437.368,351.889z
